...
// * Base componente contiene la estructura del ApiService, porque aca hago las llamadas a ApiService y necesito pasarle las interfaces
// * Cada servicio va a responder con un objeto o array diferente
...
export class BaseComponent<GET = {}, POST = {}, PUT = {}, PATCH = {}, DELETE = {}> {
  ...
  // * flag que Habilita o no algunas opciones
  loading = false;
  ...
  // * El payload en el caso del registro, va a ser una url.
